...
pub async fn portfolio_account_id_allocation_get(configuration: &configuration::Configuration, account_id: &str) -> Result<Vec<models::AllocationInner>, Error<PortfolioAccountIdAllocationGetError>> {
...
pub async fn portfolio_account_id_position_conid_get(configuration: &configuration::Configuration, account_id: &str, conid: i32) -> Result<Vec<models::PositionInner>, Error<PortfolioAccountIdPositionConidGetError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/portfolio/{accountId}/position/{conid}", local_var_configuration.base_path, accountId=crate::apis::urlencode(account_id), conid=conid);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
...
pub async fn portfolio_account_id_positions_page_id_get(configuration: &configuration::Configuration, account_id: &str, page_id: &str, model: Option<&str>, sort: Option<&str>, direction: Option<&str>, period: Option<&str>) -> Result<Vec<models::PositionInner>, Error<PortfolioAccountIdPositionsPageIdGetError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/portfolio/{accountId}/positions/{pageId}", local_var_configuration.base_path, accountId=crate::apis::urlencode(account_id), pageId=crate::apis::urlencode(page_id));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
...
pub async fn portfolio_allocation_post(configuration: &configuration::Configuration, body: models::PaSummaryPostRequest) -> Result<Vec<models::AllocationInner>, Error<PortfolioAllocationPostError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/portfolio/allocation", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
...
pub async fn portfolio_positions_conid_get(configuration: &configuration::Configuration, conid: i32) -> Result<models::PortfolioPositionsConidGet200Response, Error<PortfolioPositionsConidGetError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/portfolio/positions/{conid}", local_var_configuration.base_path, conid=conid);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
